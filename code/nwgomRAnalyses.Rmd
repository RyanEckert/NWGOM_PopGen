...
```{r, mcav het data}
setwd("~/GitHub/NWGOM_PopGen/code/")
mcavData = read.csv("../data/nwgomMetaData.csv") %>% dplyr::filter(species == "M. cavernosa") %>% dplyr::filter(!sample %in% c("MGM072.1", "MGM072.3", "MGM013.2", "MGM013.3", "MGM008.1", "MGM008.2", "MGM010", "MGM024.1", "MGM004", "MGM002.2", "MGM002.3", "MGM038.2", "MGM038.3"))
...
ggsave("../figures/figure2A.png", plot = mcavPlots, height = 14, width = 12, units = "in", dpi = 300)
...
ggsave("../figures/figure3A.png", plot = sintPlots, height = 14, width = 12, units = "in", dpi = 300)
...
ofavStructure = facet_widths(ofavP9, widths = c(0.5, 0.025, 0.025, 0.025, 0.1, 0.2, 0.1, 0.1, 0.1)) #+ inset_element(ofavImg, 0.0, 0.9, 0.1, 1.0, align_to = "full", ignore_tag = TRUE)
...
ggsave("../figures/figure4A.png", plot = ofavPlots, height = 14, width = 12, units = "in", dpi = 300)
...
ggsave("../figures/figure5A.png", plot = xestoPlots, height = 14, width = 11, units = "in", dpi = 300)
